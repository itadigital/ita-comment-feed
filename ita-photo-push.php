<?php
    ...
    $sql = 'INSERT INTO public."photoStream" ("eventName", "photoName", "description", "firstName", "lastName", "fullName", "timeStamp") VALUES (\'' . $eventName . '\', \'' . $photoName . '\', \'' . $description . '\', \'' . $firstName . '\', \'' . $lastName . '\', \'' . $fullName . '\', \'' . $ts . '\')';
